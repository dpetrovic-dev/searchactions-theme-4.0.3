...
function joints_custom_admin_footer() {
	...
	_e('<span id="footer-thankyou">Developed by <a href="#" target="_blank">SearchActions</a></span>.', 'jointswp');
...
//ADD CUSTOM ADMIN STYLESHEET - PUT LAST

function load_custom_wp_admin_style() {

        wp_register_style( 'custom_wp_admin_css', get_stylesheet_directory_uri() . '/assets-admin/admin-style.css', false, '1.0.0' );
