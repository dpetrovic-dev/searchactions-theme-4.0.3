<div class="menu2-wrapper <?php if ( get_field('global_floatingnav_truefalse','option') == true ) { ?>floating<?php } ?>">
<!-- *****************************************
                CEILING
    ****************************************** -->
...
<div class="grid-container">
    <div class="top-bar menu2" id="main-menu" itemscope itemtype="http://schema.org/SiteNavigationElement">
